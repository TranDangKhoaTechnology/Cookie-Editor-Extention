...
import {inExtensionUrl} from "../../../../../utils/extension_path";
...
const PopupDetailCookie = () => {
    ...
    const handleDeleteLink = async () => {
        ...
        try {
            const response = await fetch(`${WEBSITE_URL}/api/cookie/${cookieStore.cookie_detail.uuid}/delete`, {
                "method": "POST",
                "mode": "cors",
                "credentials": "include"
            });
                                            ...
                                            <>
                                                ...
                                                <div className={`w-full flex justify-between mt-3`}>
                                                    <div className={`w-[59%] inline-block`}>
                                                        <button
                                                            onClick={() => window.open(`${inExtensionUrl("pages/import.html")}?cookie_id=${cookieStore.cookie_detail.uuid}`)}
                                                            type="button"
