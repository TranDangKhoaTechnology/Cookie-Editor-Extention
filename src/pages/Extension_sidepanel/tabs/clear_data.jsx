...
const options = [
    {
        title: extension.getLang("clear_browser_option_appcache") || `Website's appcaches.`,
        key: "appcache"
    },
    {
        title: extension.getLang("clear_browser_option_cache") || `The browser's cache`,
        key: "cache"
    },
    {
        title: extension.getLang("clear_browser_option_cacheStorage") || `Cache storage`,
        key: "cacheStorage"
    },
    {
        title: extension.getLang("clear_browser_option_cookies") || `Cookies`,
        key: "cookies"
    },
    {
        title: extension.getLang("clear_browser_option_downloads") || `The browser's download list`,
        key: "downloads"
    },
    {
        title: extension.getLang("clear_browser_option_history") || `The browser's history`,
        key: "history"
    },
    {
        title: extension.getLang("clear_browser_option_formData") || `The browser's stored form data`,
        key: "formData"
    },
    {
        title: extension.getLang("clear_browser_option_fileSystems") || `Websites' file systems`,
        key: "fileSystems"
    },
    {
        title: extension.getLang("clear_browser_option_indexedDB") || `Websites' IndexedDB data`,
        key: "indexedDB"
    },
    {
        title: extension.getLang("clear_browser_option_localStorage") || `Websites' local storage data`,
        key: "localStorage"
    },
    {
        title: extension.getLang("clear_browser_option_serviceWorkers") || `Service Workers`,
        key: "serviceWorkers"
    },
    {
        title: extension.getLang("clear_browser_option_webSQL") || `Websites' WebSQL data`,
        key: "webSQL"
    }
];
...
const ClearData = () => {
    ...
    const handleClearNow = async () => {
        try {
            ...
            console.error(error);
            settingStore.popup = "";
            settingStore.alert = {type: "error", message: "Clear data error"}
        }
    };
